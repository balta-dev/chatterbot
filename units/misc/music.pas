...
SysUtils, crt, StrUtils;

const MaxSongs=22;
type tVectorCanciones = array [1..MaxSongs] of string;

procedure SendMCICommand(Cmd: PChar);
procedure musicFinding(var FN:tVectorCanciones; var maxSongsFound:byte; var Cmd:pchar; var songName:string; var selected:pchar);
...
procedure songSet(var FN:tVectorCanciones; var maxSongsFound:byte; var Cmd:Pchar; var songName:string; var selected:Pchar);
var aux:pchar;
begin
